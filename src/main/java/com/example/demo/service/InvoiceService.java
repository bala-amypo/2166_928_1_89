...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    private final CategoryRepository categoryRepository; // Kept for constructor consistency
    ...
    public Invoice categorizeInvoice(Long invoiceId) {
        ...
        // Get all rules ordered by priority to feed into the engine
        List<CategorizationRule> rules = ruleRepository.findAllByOrderByPriorityDesc();
        Category assigned = categorizationEngine.determineCategory(invoice, rules);
        
        invoice.setCategory(assigned);
        return invoiceRepository.save(invoice);
    }
